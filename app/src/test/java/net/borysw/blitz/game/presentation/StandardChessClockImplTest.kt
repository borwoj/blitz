...
// TODO display names
internal class StandardChessClockImplTest {
    ...
    fun addTime() {
        ...
        testedObj.addPlayerTime(ChessClock.Player.Player1, 1)
        testedObj.addPlayerTime(ChessClock.Player.Player2, 2)
